...
#>
    ...
    $MenuContext_Memory_PsComExcel               += , @('User-Agent   ',@('Microsoft Office Excel *','Microsoft Office Existence Discovery','Mozilla/* (compatible; MSIE *; Windows NT *; Win64; x64; Trident/*; .NET* .NET CLR *; ms-office; MSOffice *'))
